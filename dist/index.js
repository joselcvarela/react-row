  ...
  _createClass(Row, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          _this$props$columnWid = _this$props.columnWidth,
          columnWidth = _this$props$columnWid === void 0 ? '85.33px' : _this$props$columnWid,
          ...
          props = _objectWithoutProperties(_this$props, ["columnWidth", "gutterWidth", "children", "gutterProps", "columnProps"]);

      var columns = this.fillColumns(children);
      return _react.default.createElement(_reactInln.default, _extends({
        display: "flex",
        flexWrap: "wrap",
        flexDirection_s: "column",
        alignItems_s: "center"
      }, props), columns.map(function (_ref2, ci) {
        var component = _ref2.component,
            span = _ref2.span;
        return [_react.default.createElement(Gutter, _extends({
          key: ci + 1,
          width: _this2.gutterWidth
        }, gutterProps)), _react.default.createElement(_reactInln.default, _extends({
          key: -ci,
          flex: span
